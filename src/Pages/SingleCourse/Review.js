    ...
    return (
        <div className='p-2'>
            <div className='grid md:grid-cols-2 gap-5 rounded-md'>
                <div className='shadow p-4 '>
                    <div className='flex gap-4'>
                        ...
                        <div>
                            ...
                            <h2 className='text-sm text-gray-600'>@kamrul528</h2>
                            <h2 className='text-sm text-gray-600'>2 Course Done</h2>
                ...
                <div className='shadow p-4 '>
                    <div className='flex gap-4'>
                        <img className='w-16 h-16 ring-2 rounded-full' src="https://i.ibb.co/XDQWBfh/images.png" alt="" />
                        <div>
                            <h2 className='text-xl'>কামরুল হক</h2>
                            <h2 className='text-sm text-gray-600'>@kamrul528</h2>
                            <h2 className='text-sm text-gray-600'>2 Course Done</h2>
                ...
                <div className='shadow p-4 '>
                    <div className='flex gap-4'>
                        <img className='w-16 h-16 ring-2 rounded-full' src="https://s.udemycdn.com/home/non-student-cta/ub-1x-v3.jpg" alt="" />
                        <div>
                            <h2 className='text-xl'>কামরুল হক</h2>
                            <h2 className='text-sm text-gray-600'>@kamrul528</h2>
                            <h2 className='text-sm text-gray-600'>2 Course Done</h2>
                ...
                <div className='shadow p-4 '>
                    <div className='flex gap-4'>
                        <img className='w-16 h-16 ring-2 rounded-full' src="https://s.udemycdn.com/home/non-student-cta/instructor-1x-v3.jpg" alt="" />
                        <div>
                            <h2 className='text-xl'>কামরুল হক</h2>
                            <h2 className='text-sm text-gray-600'>@kamrul528</h2>
                            <h2 className='text-sm text-gray-600'>2 Course Done</h2>
                ...
                <div className='shadow p-4 '>
                    <div className='flex gap-4'>
                        <img className='w-16 h-16 ring-2 rounded-full' src="https://s.udemycdn.com/teaching/instructors/en/frank-1x-v2.jpg" alt="" />
                        <div>
                            <h2 className='text-xl'>কামরুল হক</h2>
                            <h2 className='text-sm text-gray-600'>@kamrul528</h2>
                            <h2 className='text-sm text-gray-600'>2 Course Done</h2>
