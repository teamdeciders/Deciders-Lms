...
const SignUp = () => {
    ...
    return (
        <div className='lg:flex justify-around mt-12'>
         ...
         <div className='md:w-[500px] w-full mx-auto shadow-xl p-8 rounded'>
             ...
             <form>
                ...
                <input type="email" className='py-3 px-3 border border-[#515FCE] rounded w-full mb-4' placeholder='Your Email Address'/>
                 ...
                 <AiOutlineEyeInvisible onClick={()=>setShowPassword(!showPassword)} className='absolute top-4 right-4 cursor-pointer' ></AiOutlineEyeInvisible>          
                   ...
                   <div className='relative'>
                  <input type={showPassword? 'text': 'password'} className='py-3 px-3 border border-[#515FCE] rounded w-full' placeholder='Confirm Password'/>
